                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-formulafont-regular text-gray-900">Shopping cart</Dialog.Title>
                        <div className="ml-3 flex h-7 items-center">
                        <button
                            type="button"
                            className="relative -m-2 p-2 text-gray-400 hover:text-gray-500"
                            onClick={() => {
                            setOpen(false); // Close the shopping cart panel
                              ...
                              <li key={product.id} className="flex py-6">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm font-formulafont-regular text-gray-500">{product.color}</p>
                                  </div>
                                  <div className="flex flex-1 items-end justify-between text-sm">
                                    <p className="font-formulafont-regular text-gray-500">Qty {product.quantity}</p>
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <div className="mt-6 flex justify-center text-center text-sm font-formulafont-regular text-gray-500">
                        <p>
                            ...
                            <button
                            type="button"
                            className="font-medium text-formula-red hover:text-formula-red"
                            onClick={() => {
                                navigate('/products'); // Navigate to the "Products" page
                            }}
                            >
